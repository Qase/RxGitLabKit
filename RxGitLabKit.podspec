#
#  Be sure to run `pod spec lint RxGitLabKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Dagy Tran" => "dagytran@gmail.com" }
  # Or just: s.author    = "Dagy Tran"
  # s.authors            = { "Dagy Tran" => "dagytran@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Dagy Tran"
  ...
  s.source_files  = "Sources/*.swift", "Sources/Supporting\ Files/*.swift"
